...
\usepackage{hyperref}
\hypersetup{
  pdftitle={EXAMPLE MICRONOTE! ~\newline A SAMPLE DOCUMENT FOR A MICRONOTE},
  pdfauthor={Aaron Wong, Aaron Wong},
  pdfsubject={Example Document, Australian Economics},
  pdfkeywords={Structural Policy, Education, Housing, Social Policy, Event Study},
}
